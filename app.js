...
function render(){
 ...
 $("popularGrid").innerHTML=current.map((g,i)=>{
   const item=card(g,i);
   return i===5 ? item+`<div class="grid-banner-ad argames-ad-slot" data-banner-id="1499097" aria-label="Advertisement 300 x 100"><span>AD SPACE</span><small>300 × 100</small></div>` : item;
 }).join("");
